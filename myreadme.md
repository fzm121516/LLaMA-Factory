...
llamafactory-cli train \
    ...
    --packing False \
    --report_to none \
    --output_dir saves/Qwen2-VL-7B-Instruct/lora/train_2025-04-10-02-26-99 \
    --bf16 True \
    --plot_loss True \
    --trust_remote_code True \
    --ddp_timeout 180000000 \
    ...
    --preprocessing_num_workers 16 \
    --preprocessing_batch_size 1 \
    --tokenized_path /data/LLaMA-Factory/tokenized1


llamafactory-cli export examples/merge_lora/qwen2vl_lora_sft2245.yaml

llamafactory-cli export examples/merge_lora/qwen2vl_lora_sft1500.yaml
...
llamafactory-cli train \
    ...
    --packing False \
    --report_to none \
    --output_dir saves/Qwen2.5-VL-7B-Instruct/lora/train_2025-04-11-09-32-66 \
    --bf16 True \
    --plot_loss True \
    --trust_remote_code True \
    --ddp_timeout 180000000 \
