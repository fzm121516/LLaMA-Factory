...
from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, PreTrainedModel,Qwen2VLForConditionalGeneration,AutoProcessor
...
def block_expansion(
    ...
    try:
        ...
        print(f"Warning: Could not save processor - {str(e)}")
